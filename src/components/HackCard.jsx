				...
				<div className='flex justify-between items-center gap-2 flex-wrap'>
					{role !== 'host' ? (
						<button
							...
							className='px-3 py-2 text-sm font-medium text-white cursor-pointer bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-700'
						>
							Register
						</button>
					) : (
