			...
			<form className='w-1/5 mx-auto' onSubmit={handleSubmit}>
				...
				<div className='flex gap-4'>
					...
					<Link to='/login'>
						<button
							type='button'
							className='text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center'
						>
							Login
						</button>
					</Link>
